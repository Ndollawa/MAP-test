...
const MessageDropDown = () => {
  return (
    <label htmlFor='messages' className="cursor-pointer select-none relative">
...
<input type="checkbox" name="messages" id="message" className='hidden peer' />
<div id="dropdownNotification" className="absolute z-20 hidden  peer-[:checked]:block w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-700" aria-labelledby="dropdownNotificationButton">
